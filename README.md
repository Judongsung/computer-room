...
현재 UI는 1024×640 이상의 데스크톱 환경만 지원합니다. 한 번에 한 항목과 한 파일만 선택할 수 있으며 문서 미리보기·파일 내용 편집, 검색, 드래그 앤 드롭, 다중 선택과 공유 링크는 지원하지 않습니다. 위젯 닫기·삭제 기능도 다음 범위로 미뤘으며 위젯의 닫기 버튼은 비활성 상태로 표시합니다. 시스템 앱과 미디어 뷰어의 닫기 버튼은 정상 동작합니다.

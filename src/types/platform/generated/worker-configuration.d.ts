/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example src/types/platform/generated/worker-configuration.d.ts` (hash: 2a4744f3aa58cf37b5713fad39c3d7cd)
// Runtime types generated with workerd@1.20260815.1 2026-08-20 nodejs_compat
interface __BaseEnv_Env {
	FILES: R2Bucket;
	DB: D1Database;
	GUEST_METADATA_RATE_LIMITER: RateLimit;
	GUEST_BINARY_RATE_LIMITER: RateLimit;
	...
	TEAM_DOMAIN: string;
	POLICY_AUD: string;
	INTEGRATION_UPLOAD_POLICY_AUD: string;
	NOVELAI_UPLOAD_POLICY_AUD: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DEV_AUTH_BYPASS" | "OWNER_EMAIL" | "TEAM_DOMAIN" | "POLICY_AUD" | "INTEGRATION_UPLOAD_POLICY_AUD" | "NOVELAI_UPLOAD_POLICY_AUD">> {}
}

...
CREATE TABLE `__backup_0011_filesystem_widget_entries` AS
...
CREATE TABLE `__backup_0011_desktop_widget_order` AS
...
CREATE TABLE `__new_dashboard_widgets` (
	...
	CONSTRAINT "dashboard_widgets_type_check" CHECK("__new_dashboard_widgets"."type" IN ('memo', 'daily-checklist', 'storage-status', 'image-upload-profiles')),
...
SELECT `id`, `parent_id`, `kind`, `name`, `name_key`, `file_id`, `widget_id`,
       `restore_parent_id`, `restore_path`, `trashed_at`, `created_at`, `updated_at`
FROM `__backup_0011_filesystem_widget_entries`;--> statement-breakpoint
INSERT INTO `desktop_entry_order` (`entry_id`, `sort_order`)
SELECT `entry_id`, `sort_order`
FROM `__backup_0011_desktop_widget_order`;--> statement-breakpoint
-- migration-safety: allow-table-drop __backup_0011_memo_widgets
DROP TABLE `__backup_0011_memo_widgets`;--> statement-breakpoint
-- migration-safety: allow-table-drop __backup_0011_checklist_items
DROP TABLE `__backup_0011_checklist_items`;--> statement-breakpoint
-- migration-safety: allow-table-drop __backup_0011_checklist_daily_states
DROP TABLE `__backup_0011_checklist_daily_states`;--> statement-breakpoint
-- migration-safety: allow-table-drop __backup_0011_checklist_events
DROP TABLE `__backup_0011_checklist_events`;--> statement-breakpoint
-- migration-safety: allow-table-drop __backup_0011_filesystem_widget_entries
DROP TABLE `__backup_0011_filesystem_widget_entries`;--> statement-breakpoint
-- migration-safety: allow-table-drop __backup_0011_desktop_widget_order
DROP TABLE `__backup_0011_desktop_widget_order`;
